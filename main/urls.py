...
urlpatterns = [
    ...
    path(
        "agendamento/remover/<int:id>/", agendamento_remover, name="agendamento_remover"
    ),
    path(
        "agendamento/detalhas/<int:id>/",
        agendamento_detalhar,
        name="agendamento_detalhar",
    ),
    ...
    path(
        ...
        auth_views.PasswordResetDoneView.as_view(
            template_name="senha/password_reset_done.html"
        ),
    ...
    path(
        ...
        auth_views.PasswordResetConfirmView.as_view(
            template_name="senha/password_reset_confirm.html"
        ),
    ...
    path(
        ...
        auth_views.PasswordResetCompleteView.as_view(
            template_name="senha/password_reset_complete.html"
        ),
